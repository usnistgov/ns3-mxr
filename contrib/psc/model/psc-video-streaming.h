...
private:
  ...
  //TR++
  bool m_enableSeqTsSizeHeader{true}; //!< Enable or disable the SeqTsSizeHeader

  /// Callback for tracing the packet Tx events, includes source, destination,  the packet sent,
  /// and header
  TracedCallback<Ptr<const Packet>, const Address&, const Address&, const SeqTsSizeHeader&, const uint32_t&>
