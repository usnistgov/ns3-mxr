...
PscVideoStreaming::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::psc::PscVideoStreaming")
    ...
    .AddAttribute("EnableSeqTsSizeHeader",
                        ...
                        BooleanValue(true),
                        MakeBooleanAccessor(&PscVideoStreaming::m_enableSeqTsSizeHeader),
                        MakeBooleanChecker()) //TR++ added to handle delay calculation
    .AddTraceSource("TxWithSeqTsSize",
                    "A new packet is created with SeqTsSizeHeader",
                    MakeTraceSourceAccessor(&PscVideoStreaming::m_txTraceWithSeqTsSize),
                    "ns3::psc::PscVideoStreaming::SeqTsSizeCallback") //TR++ added to handle delay calculation
    .AddTraceSource ("Tx",
